...
public class TermRandomizerTest {
  ...
  public void setup() throws IOException {
    // when google guava is finally released to maven, this line can replace the 6 lines below
    //    wordList = Resources.readLines(Resources.getResource("word-list.txt"), Charsets.UTF_8);

    // 512 words from PGP
    InputStream is = TermRandomizerTest.class.getResourceAsStream("/word-list.txt");
